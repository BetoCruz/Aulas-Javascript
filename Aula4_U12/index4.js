...
console.log(umaString.lastIndexOf("texto", index));//começa do final p/  começo buscando
...
console.log(umaString.search(/x/)); //retorna o index do argumento parametrizado.

console.log(umaString.replace('um', 'outra')); //substitui o primeiro parametro pelo segundo.
console.log(umaString.replace(/r/g, '#'));// busca globalmente os "r" e troca por "#"
...
console.log(umaString.slice( -5, -1));// fatia no valor da extensão menos cindo (-5), recebe parametros de inicio e fim.
